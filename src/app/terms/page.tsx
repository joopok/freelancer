...
export default function TermsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8 min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <motion.div
        initial="hidden"
        animate="visible"
        variants={fadeIn}
      ...
      >
        <h1 className="text-3xl font-bold text-center mb-10 text-gray-800 dark:text-white dark:text-white">이용약관</h1>
              ...
              <button
                ...
                className={`inline-block py-4 px-4 text-sm font-medium ${
                  activeTab === tab.id
                    ...
                    : 'text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 border-b-2 border-transparent hover:border-gray-300 dark:hover:border-gray-600'
        ...
        <motion.div 
          ...
          className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-300"
        >
          {activeTab === 'general' && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">제 1 장 총칙</h2>
              ...
              <div className="space-y-4">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 2 조 (정의)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
              ...
              <h2 className="text-xl font-bold text-gray-800 dark:text-white mt-8">제 2 장 서비스 이용</h2>
              
              <div className="space-y-4">
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 4 조 (서비스의 제공)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 5 조 (서비스의 중단)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
          ...
          {activeTab === 'membership' && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">제 1 장 회원 가입 및 관리</h2>
              
              <div className="space-y-4">
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 1 조 (회원가입)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 2 조 (회원 탈퇴 및 자격 상실)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
          ...
          {activeTab === 'payment' && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">제 1 장 결제 및 환불</h2>
              
              <div className="space-y-4">
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 1 조 (결제방법)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 2 조 (환불규정)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
                ...
                <section>
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-white">제 3 조 (과오금)</h3>
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
