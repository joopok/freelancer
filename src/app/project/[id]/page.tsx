...
function FreelancerPage() {
  ...
  useEffect(() => {
    const updateUrlParams = () => {
        ...
        // The original code pushed to /freelancer, which seems wrong for this page.
        // I'll keep it for now to fix the build, but this should be reviewed.
        const newUrl = queryString ? `/freelancer?${queryString}` : '/freelancer';
                  ...
                  <div className="flex flex-wrap gap-2" >
                      ...
                      )}
                    {
                      (hourlyRateMin || hourlyRateMax) && (
                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-white dark:bg-gray-800 rounded-full text-xs border border-blue-200 dark:border-blue-700" >
                          시급: {hourlyRateMin || '0'} ~{hourlyRateMax || '∞'}
                          만원
                          <button
                            onClick={() => {
                              setHourlyRateMin('');
                                  ...
                                  <div className="flex items-center text-sm text-gray-600 dark:text-gray-300" >
                                    ...
                                    <span className="flex items-center" >
                                      <svg className="w-4 h-4 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20" >
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                      </svg>
