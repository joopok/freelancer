  ...
  useEffect(() => {
    ...
    if (freelancer?.hourlyRate) {
      if (typeof freelancer.hourlyRate === 'string') {
        hourlyRateValue = parseInt((freelancer.hourlyRate as string).replace(/[^0-9]/g, '') || '0');
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-lg font-semibold text-blue-600 dark:text-blue-400">
                            {freelancer.repeatClientRate ?? 0}%
                          </span>
                        </div>
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          평균보다 {(freelancer.repeatClientRate ?? 0) - 30 > 0 ? '+' : ''}{(freelancer.repeatClientRate ?? 0) - 30}%
                        </p>
                      </div>
            ...
            {activeTab === 'pricing' && (
              <div className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                  ...
                  {/* 가용성 캘린더 */}
                  <div className="mb-6">
                    <AvailabilityCalendar freelancerId={String(freelancer.id)} />
                  </div>
